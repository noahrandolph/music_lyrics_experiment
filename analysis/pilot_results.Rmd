...
Determine what the effect size should be OR use the effect size from the pilot experiment (0.28/5 questions = 0.056):
```{r}
...
```{r}
pwr.t.test(power = 0.8, d = 0.2, sig.level = 0.05, type = "two.sample", alternative = "greater")
```
